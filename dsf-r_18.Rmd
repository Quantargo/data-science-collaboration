...
![Image Title](img/The Righteous Mind.jpg){width=400px}
...
Since Companies have started to build up data science teams:
...
## HDF5 package development

From a package developer's point of view:

- Store large amounts of data, e.g. tick data
- Chose HDF5 for Programming language independence, partial I/O, high performance
- Unsatisfied with rhdf5, hdf5, h5r, ...
- Write my own package!!!

![Image Title](img/data_exchange3.png){width=500px}
...
Tools used: E-mail, Git, Screwdriver
